          ...
          <div className="bg-white rounded-lg shadow-md p-4 md:p-8 mb-6">
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4 mb-8 pb-6 border-b-2 border-gray-300">
              ...
              <div className="md:text-right">
                ...
                <p className="font-bold text-lg font-mono break-all">{orderData.orderNumber}</p>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8 pb-6 border-b">
              {orderData.payerInfo && (
                <div>
                  ...
                  {orderData.payerInfo.email_address && (
                    <p className="text-sm text-gray-600 break-all">{orderData.payerInfo.email_address}</p>
                  )}
                </div>
              )}
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1 break-all">Transaction ID: {orderData.paypalOrderId}</p>
              </div>
              <div>
              ...
              <div className="md:hidden space-y-4">
                ...
                <div className="border-t-2 border-gray-300 pt-4 space-y-2">
                  ...
                  <div className="flex justify-between text-lg pt-2 border-t border-gray-300">
                    ...
                    <span className="font-bold text-green-600">${(orderData.total / 100).toFixed(2)}</span>
                  </div>
                </div>
              </div>
